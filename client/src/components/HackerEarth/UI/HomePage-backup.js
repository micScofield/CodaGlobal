...
import { addTeam, loadTeams, result } from '../../store/actions'
import Spinner from './UI/Spinner'
import Modal from './UI/Modal'

const HomePage = ({ addTeam, loading, alertMsg, alertType, teamsDB, loadTeams, result }) => {
    ...
    console.log('setting values for display teams by score')
    console.log(teamsDB) //has teams

    //make sorting here according to score by default
    let sortedTeams
    const copied = [...teamsDB]
    sortedTeams = copied.sort(function (a, b) {
    ...
    let content = (
        <Fragment>
            <div className='container'>
                ...
                <span><button className='btn btn-primary' onClick={sortByTeamNameHandler}>Sort By Team Name</button></span>
...
export default connect(mapStateToProps, { addTeam, loadTeams, result })(HomePage)